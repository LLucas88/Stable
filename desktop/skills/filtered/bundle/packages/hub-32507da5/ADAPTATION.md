...
技能 ID：`hub-32507da5-guoyiyi-wechat-group-campaign`

原始名称：微信群活动运营｜郭亿易

中文用途概括：输入群画像、活动目标、奖品和时间，产出群内节奏表、主持话术和转化动作，适合社群运营与私域团队。

适用方向：互联网业务、运营岗位、会员运营、内容运营。四方向评分：{"internet": 50, "operations": 95, "membership": 50, "content": 65}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/guoyiyi-wechat-group-campaign?namespace=user_8d36cde0
