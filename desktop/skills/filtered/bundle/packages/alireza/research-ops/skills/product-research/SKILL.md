...
metadata:
  source-name: product-research
  bundle: ops-expanded-2026-09-06
  upstream-version: 2.9.0
  upstream-author: claude-code-skills
  upstream-tags: '["research-ops", "product-research", "ux-research", "jtbd", "usability", "saturation", "insight-synthesis", "research-repository"]'
