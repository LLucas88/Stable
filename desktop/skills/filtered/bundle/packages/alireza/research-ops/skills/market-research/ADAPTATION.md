...
技能 ID：`alireza-market-research`

原始名称：market-research

中文用途概括：支持搜索流量、关键词、页面结构或内容优化。

适用方向：互联网业务、运营岗位。四方向评分：{"internet": 53, "operations": 95, "membership": 0, "content": 0}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
Python 非标准库导入候选（可能含本地模块，并非可直接 pip 安装清单）：config_loader, market_sizer。
...
来源：https://github.com/alirezarezvani/claude-skills/tree/19392f7a08264ed00486a251f5b2098321771f94/research-ops/skills/market-research
