---
name: alireza-procurement-optimizer
...
metadata:
  source-name: procurement-optimizer
  bundle: ops-expanded-2026-09-06
  upstream-version: 2.8.0
  upstream-author: claude-code-skills
  upstream-tags: '["bizops", "procurement", "spend-categorization", "supplier-consolidation", "unspsc", "saas-audit", "purchasing-cycle"]'
