...
metadata:
  source-name: capacity-planner
  bundle: ops-expanded-2026-09-06
  upstream-version: 2.8.0
  upstream-author: claude-code-skills
  upstream-tags: '["bizops", "capacity", "headcount", "utilization", "queueing-theory", "ops-planning", "little-law", "workforce"]'
