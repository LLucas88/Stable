---
name: alireza-business-operations-skills
...
metadata:
  source-name: business-operations-skills
  bundle: ops-expanded-2026-09-06
  upstream-context: fork
  upstream-version: 2.8.0
  upstream-author: claude-code-skills
  upstream-tags: '["bizops", "operations", "process", "vendor", "capacity", "sop", "procurement", "coo", "orchestrator"]'
  upstream-compatible_tools: '["claude-code", "codex-cli", "cursor", "antigravity", "opencode", "gemini-cli"]'
  upstream-metadata: '{}'
license: MIT
---
