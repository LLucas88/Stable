---
name: alireza-marketing-demand-acquisition
...
metadata:
  source-name: marketing-demand-acquisition
  bundle: ops-expanded-2026-09-06
  upstream-triggers: '["demand gen", "demand generation", "paid ads", "paid media", "LinkedIn ads", "Google ads", "Meta ads", "CAC", "customer acquisition cost", "lead generation", "MQL", "SQL", "pipeline generation", "acquisition strategy", "HubSpot campaigns"]'
  upstream-metadata: '{"version": "1.1.0", "author": "Alireza Rezvani", "category": "marketing", "domain": "demand-generation", "updated": "2026-06"}'
---
