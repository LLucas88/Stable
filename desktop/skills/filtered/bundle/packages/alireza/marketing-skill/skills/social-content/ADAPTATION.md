...
技能 ID：`alireza-social-content`

原始名称：social-content

中文用途概括：支持内容策划、写作、编辑、分发或质量检查。

适用方向：运营岗位、内容运营。四方向评分：{"internet": 0, "operations": 60, "membership": 0, "content": 92}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://github.com/alirezarezvani/claude-skills/tree/19392f7a08264ed00486a251f5b2098321771f94/marketing-skill/skills/social-content
