---
name: alireza-commercial-skills
...
metadata:
  source-name: commercial-skills
  bundle: ops-expanded-2026-09-06
  upstream-context: fork
  upstream-version: 2.8.0
  upstream-author: claude-code-skills
  upstream-tags: '["commercial", "pricing", "deal-desk", "partnerships", "channel", "rfp", "forecast", "cro", "orchestrator"]'
