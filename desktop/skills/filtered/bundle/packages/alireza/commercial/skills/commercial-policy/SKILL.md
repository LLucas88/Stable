---
name: alireza-commercial-policy
...
metadata:
  source-name: commercial-policy
  bundle: ops-expanded-2026-09-06
  upstream-version: 2.8.0
  upstream-author: claude-code-skills
  upstream-tags: '["commercial", "discount-policy", "discount-matrix", "exception-flow", "governance", "deal-framework", "commercial-discipline"]'
