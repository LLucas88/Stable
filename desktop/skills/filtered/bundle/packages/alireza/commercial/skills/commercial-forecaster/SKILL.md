---
name: alireza-commercial-forecaster
...
metadata:
  source-name: commercial-forecaster
  bundle: ops-expanded-2026-09-06
  upstream-version: 2.8.0
  upstream-author: claude-code-skills
  upstream-tags: '["commercial", "forecasting", "bookings", "arr", "nrr", "grr", "cohort", "funnel", "pipeline-math"]'
