---
name: alireza-channel-economics
...
metadata:
  source-name: channel-economics
  bundle: ops-expanded-2026-09-06
  upstream-version: 2.8.0
  upstream-author: claude-code-skills
  upstream-tags: '["commercial", "channel-economics", "cost-to-serve", "channel-mix", "channel-roi", "direct-vs-partner", "unit-economics"]'
