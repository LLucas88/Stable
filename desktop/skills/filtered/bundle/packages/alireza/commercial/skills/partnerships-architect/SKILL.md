---
name: alireza-partnerships-architect
...
metadata:
  source-name: partnerships-architect
  bundle: ops-expanded-2026-09-06
  upstream-version: 2.8.0
  upstream-author: claude-code-skills
  upstream-tags: '["commercial", "partnerships", "channel-partners", "joint-gtm", "revshare", "oem", "reseller", "strategic-alliance"]'
