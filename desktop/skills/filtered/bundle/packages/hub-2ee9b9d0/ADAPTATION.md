...
技能 ID：`hub-2ee9b9d0-private-domain-playbook`

原始名称：private-domain-playbook

中文用途概括：中国私域运营完整战术手册。覆盖加粉链路、企微 SOP、社群分层、朋友圈节奏、复购触发、流失召回、组织搭建。基于微信生态，含合规警告。

适用方向：运营岗位、会员运营、内容运营。四方向评分：{"internet": 0, "operations": 95, "membership": 95, "content": 50}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/private-domain-playbook?namespace=user_36c7efa2
