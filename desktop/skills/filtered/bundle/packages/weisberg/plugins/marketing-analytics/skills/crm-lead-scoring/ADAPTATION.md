...
技能 ID：`weisberg-crm-lead-scoring`

原始名称：crm-lead-scoring

中文用途概括：支持该技能原文描述的互联网业务或运营工作流。

适用方向：互联网业务、运营岗位、会员运营。四方向评分：{"internet": 65, "operations": 92, "membership": 89, "content": 0}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
Python 非标准库导入候选（可能含本地模块，并非可直接 pip 安装清单）：numpy, pandas, scikit-learn, scipy, shap。
...
来源：https://github.com/weisberg/agile_agentic_analytics/tree/630273d085faf298260a7e7631cfc6d301a6f782/plugins/marketing-analytics/skills/crm-lead-scoring
