...
技能 ID：`kostja-multi-domain-brand-seo`

原始名称：multi-domain-brand-seo

中文用途概括：支持搜索流量、关键词、页面结构或内容优化。

适用方向：互联网业务、运营岗位、内容运营。四方向评分：{"internet": 89, "operations": 65, "membership": 0, "content": 86}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://github.com/kostja94/marketing-skills/tree/70987bad4ebe9dce1f74858c1c64f3f8810f18e4/skills/strategies/commercial/domain/multi-domain-brand-seo
