...
技能 ID：`hub-1c79d18b-guoyiyi-private-domain-welcome`

原始名称：私域欢迎语｜郭亿易

中文用途概括：输入用户来源、权益和首个沟通目标，产出分来源欢迎语、首次提问和标签建议，适合私域运营与销售顾问。

适用方向：运营岗位、会员运营。四方向评分：{"internet": 0, "operations": 89, "membership": 89, "content": 0}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/guoyiyi-private-domain-welcome?namespace=user_8d36cde0
