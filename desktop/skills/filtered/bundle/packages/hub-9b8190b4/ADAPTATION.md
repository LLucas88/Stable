...
技能 ID：`hub-9b8190b4-community-group-buying-acquisition-retention`

原始名称：community-group-buying-acquisition-retention

中文用途概括：社区团购获客与留存全链路技能包：获客渠道矩阵、社群运营SOP、用户分层体系、复购激励、各平台获客差异及配套工具。适用于平台运营和团长管理。不含选品（模块一）与团长运营（模块二）。

适用方向：运营岗位、会员运营。四方向评分：{"internet": 0, "operations": 95, "membership": 56, "content": 0}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/03-acquisition-retention?namespace=clawhub_nic-yuan
