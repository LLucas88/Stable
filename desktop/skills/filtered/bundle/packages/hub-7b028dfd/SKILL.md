---
name: hub-7b028dfd-taobao-competitor-analyzer
...
metadata:
  source-name: taobao-competitor-analyzer
  bundle: ops-expanded-2026-09-06
  upstream-slug: taobao
  upstream-version: 2.1.1
  upstream-displayName: 淘宝比价
  upstream-summary: 跨平台电商比价助手。输入淘宝商品标题或链接，在京东、拼多多、唯品会三大平台搜寻同款，规格化价格、匹配度评分，输出购买建议。
  upstream-tags: '["e-commerce", "price-comparison", "shopping", "browser", "电商", "比价"]'
  upstream-homepage: https://github.com/harrylabsj/taobao-competitor-analyzer
  upstream-metadata: '{}'
license: MIT
---
