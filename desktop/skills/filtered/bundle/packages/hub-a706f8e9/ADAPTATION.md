...
技能 ID：`hub-a706f8e9-community-operation-zh`

原始名称：community-operation-zh

中文用途概括：为微信群、企微群、训练营、付费社群设计入群、破冰、内容节奏、活跃、转化和流失召回 SOP。

适用方向：互联网业务、运营岗位、会员运营、内容运营。四方向评分：{"internet": 50, "operations": 95, "membership": 53, "content": 50}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/community-operation-zh?namespace=user_36c7efa2
