...
**AI 也适合看**：如果你是 AI Agent（WorkBuddy / Claude / Codex / Cursor …），你的入口在 [llms.txt](llms.txt) 和 [AGENTS.md](AGENTS.upstream.md)；本仓库同时是一个可安装的 **Agent Skill**（[SKILL.md](SKILL.md)），装法见[下方](#-当-agent-skill-用)。
...
| 我想做的事 | 直接去 |
|---|---|
| 找某个指标怎么算（复购率、RFM、核销率…） | [公式库/README.md](%E5%85%AC%E5%BC%8F%E5%BA%93/README.md) → 按主题找分册 |
...
| 先看故事再翻表 | [分享/区域运营的一天/](%E5%88%86%E4%BA%AB/%E5%8C%BA%E5%9F%9F%E8%BF%90%E8%90%A5%E7%9A%84%E4%B8%80%E5%A4%A9/README.md) |
...
从老板到店长到加盟商，每个角色一张自己的报表。清单见 [清单/看板清单.csv](%E6%B8%85%E5%8D%95/%E7%9C%8B%E6%9D%BF%E6%B8%85%E5%8D%95.csv)，每张的卡片明细在 [看板/页面文档/](./看板/页面文档/)。
...
| 分册 | 管什么 |
|---|---|
| [01 日期与时间](%E5%85%AC%E5%BC%8F%E5%BA%93/01-date-and-time.md) | T-1、本月、近 N 天、用餐时段、跨月对齐、观远时间宏 |
| [02 顾客与会员](%E5%85%AC%E5%BC%8F%E5%BA%93/02-customer-and-membership.md) | 新老客、消费频次 3 口径、复购（跨天 vs 非跨天）、RFM 8 类 × 营销策略、留存流失 |
| [03 营收 KPI](%E5%85%AC%E5%BC%8F%E5%BA%93/03-revenue-kpi.md) | 客单价 AC、ADS、ADT、Comp 同店、会员贡献占比 |
| [04 渠道与门店](%E5%85%AC%E5%BC%8F%E5%BA%93/04-channel-and-store.md) | 堂食外卖分流、门店生命周期、多渠道评价 pipeline |
| [05 券与折扣](%E5%85%AC%E5%BC%8F%E5%BA%93/05-coupon-and-discount.md) | 核销率、折扣率、折扣分桶、注册首张券 |
| [06 SQL 工具箱](%E5%85%AC%E5%BC%8F%E5%BA%93/06-sql-utils.md) | 字符串拆解、开窗排名、累计窗口 |
| [07 数据质量坑](%E5%85%AC%E5%BC%8F%E5%BA%93/07-data-quality-traps.md) | NULL / 空串 / 'null' 三态、口径歧义、通用字段词典 |
| [08 ETL 工程范式](%E5%85%AC%E5%BC%8F%E5%BA%93/08-etl-engineering-patterns.md) | DWD 宽表底座、财务双源对账、POS 归一化、Cohort 网格 |
| [09 生产 ETL 索引](%E5%85%AC%E5%BC%8F%E5%BA%93/09-etl-catalog.md) | 39 个生产 ETL 按 11 个业务域的索引与复用决策表 |
| [10 任务与触达回收](%E5%85%AC%E5%BC%8F%E5%BA%93/10-task-and-touch-recovery.md) | 白盒 NBA 任务池模型、九类任务×圈选依据、防打扰与仲裁、漏斗四率回收、差评客户挽回 |

总入口和"5 条最容易踩的坑"见 [公式库/README.md](%E5%85%AC%E5%BC%8F%E5%BA%93/README.md)。**样板间的表结构 + 公式库的算法，两样凑齐，是方案评审和二次开发的图纸；生产上线还要完成字段映射、口径确认和回归验收。**

## 一场直播，把这套东西讲了一遍

2026 年 7 月，这套体系的设计思路在观远「对话 AI Hero」直播里完整讲过一次（AI 创新赛一等奖作品《区域运营的一天》）：区域运营一上午的巡店分析，AI 怎么压缩到几分钟，怎么归因到人、怎么学会闭嘴、怎么多看一眼。

**[📖 分享/区域运营的一天/](%E5%88%86%E4%BA%AB/%E5%8C%BA%E5%9F%9F%E8%BF%90%E8%90%A5%E7%9A%84%E4%B8%80%E5%A4%A9/README.md)** —— 34 页插画板全嵌的书面实录，当时演示的数据环境就是本仓库。想先看故事再翻表的，从这里进。
...
**① 业务同学：对照自查。** 打开 [数据集/数据样本/dws_会员RFM分层.csv](./数据集/数据样本/)，你嘴里的"复购""流失""分层"在数据里就长这样。拿 [清单/数据集清单.csv](%E6%B8%85%E5%8D%95/%E6%95%B0%E6%8D%AE%E9%9B%86%E6%B8%85%E5%8D%95.csv) 当清单，对照你公司现在的会员体系，缺哪层、缺哪几张表，一眼看得出来。
...
AI 会自己顺着 [llms.txt](llms.txt) 和 [AGENTS.md](AGENTS.upstream.md) 找到路，不用你解释仓库结构。
