---
name: hub-a8d05726-majia-huiyuan
...
metadata:
  source-name: majia-huiyuan
  bundle: ops-expanded-2026-09-06
  upstream-slug: majia-huiyuan
  upstream-version: 1.4.1
  upstream-displayName: 会员运营 · 马甲实战版
  upstream-homepage: https://github.com/maojiebc/majia-huiyuan
  upstream-metadata: '{"version": "1.4.1", "author": "超级马甲 / maojiebc", "homepage": "https://github.com/maojiebc/majia-huiyuan", "openclaw": {"emoji": "🪪", "homepage": "https://github.com/maojiebc/majia-huiyuan"}}'
license: MIT
---
...
更多命名约定与文件形态说明见 [AGENTS.md](AGENTS.upstream.md)；机器可读索引见 [llms.txt](llms.txt)。
