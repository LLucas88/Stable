...
技能 ID：`hub-80999475-shortform-hook-writer`

原始名称：shortform-hook-writer

中文用途概括：为 TikTok、Instagram Reels、YouTube Shorts 及幻灯片/轮播式短视频内容创作自然、高留存率的钩子和开场白（英文）

适用方向：运营岗位、会员运营、内容运营。四方向评分：{"internet": 0, "operations": 50, "membership": 50, "content": 59}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/shortform-hook-writer?namespace=clawhub_wotaso-dev
