---
name: lenny-product-tool-stack
description: Help users select, implement, and optimize a modern product tool stack that reduces operational friction and accelerates delivery cycles.
metadata:
  source-name: product-tool-stack
