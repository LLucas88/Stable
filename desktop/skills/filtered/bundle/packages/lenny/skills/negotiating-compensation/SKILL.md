---
name: lenny-negotiating-compensation
description: Help users navigate the end-to-end negotiation process for product and engineering roles, from initial recruiter calls to evaluating startup equity and final offer signing.
metadata:
  source-name: negotiating-compensation
...
1. **Benchmark your value** - Map your current and target roles to standardized job levels and percentile data to find your true market range.
2. **Gather interview intelligence** - Use specific questions during the interview process to uncover team priorities and the company's internal budget bands.
3. **Deploy deflection scripts** - Provide exact wording to avoid sharing salary expectations early and instead pivot the conversation to the company's budget.
4. **Evaluate the total package** - Analyze equity components like an investor while maximizing non-financial levers like work-life flexibility.
