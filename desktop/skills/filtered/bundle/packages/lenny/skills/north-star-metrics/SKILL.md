---
name: lenny-north-star-metrics
description: Help users define, validate, and operationalize a North Star Metric that bridges the gap between customer value and business success while driving team alignment.
metadata:
  source-name: north-star-metrics
