---
name: lenny-growth-model
description: Help users transition from linear funnel thinking to a loop-based growth model that identifies and optimizes the core engines of their business.
metadata:
  source-name: growth-model
