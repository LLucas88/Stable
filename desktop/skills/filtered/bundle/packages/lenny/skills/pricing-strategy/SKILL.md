---
name: lenny-pricing-strategy
description: Help users validate willingness-to-pay, select the right value metrics, and continuously optimize pricing and packaging to drive growth.
metadata:
