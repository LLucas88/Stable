...
技能 ID：`hub-a4330fac-ecommerce-data-zh`

原始名称：ecommerce-data-zh

中文用途概括：把淘宝、天猫、抖店、快手小店、视频号小店的经营数据整理成运营看板和诊断结论。

适用方向：互联网业务、运营岗位、内容运营。四方向评分：{"internet": 68, "operations": 86, "membership": 0, "content": 53}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/ecommerce-data-zh?namespace=user_36c7efa2
