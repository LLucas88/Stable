...
技能 ID：`hub-16105d48-copywriter`

原始名称：copywriter

中文用途概括：撰写引人入胜的UX文案、营销内容和产品信息。适用于按钮标签、错误提示、落地页、邮件、行动号召、空状态页面等场景。

适用方向：互联网业务、运营岗位、内容运营。四方向评分：{"internet": 50, "operations": 50, "membership": 0, "content": 89}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/copywriter-1-1-0?namespace=clawhub_gwsq
