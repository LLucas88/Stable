...
技能 ID：`corey-copywriting`

原始名称：copywriting

中文用途概括：支持内容策划、写作、编辑、分发或质量检查。

适用方向：互联网业务、运营岗位、内容运营。四方向评分：{"internet": 56, "operations": 65, "membership": 0, "content": 86}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://github.com/coreyhaines31/marketingskills/tree/5b2c0007766c6a1cf1d53fd8fc73e979e0821022/skills/copywriting
