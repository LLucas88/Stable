...
技能 ID：`corey-churn-prevention`

原始名称：churn-prevention

中文用途概括：分析留存或流失问题，制定召回、续费与复购动作。

适用方向：运营岗位、会员运营。四方向评分：{"internet": 0, "operations": 92, "membership": 89, "content": 0}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://github.com/coreyhaines31/marketingskills/tree/5b2c0007766c6a1cf1d53fd8fc73e979e0821022/skills/churn-prevention
