...
技能 ID：`hub-2639ce92-seedance-director`

原始名称：seedance-director

中文用途概括：引导用户在Seedance（即梦）平台上完成AI视频制作——从创意构思与素材准备，到分镜设计，直至生成可执行的制作提示。激活关键词包括Seedance、即梦、AI视频、分镜、运镜、视频延长、一镜到底。

适用方向：内容运营。四方向评分：{"internet": 0, "operations": 0, "membership": 0, "content": 65}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/seedance-director?namespace=user_d5c3472c
