...
技能 ID：`hub-e0f69de3-douyin-script-zh`

原始名称：douyin-script-zh

中文用途概括：针对抖音平台特性写的爆款短视频脚本生成器——3 秒钩子 + 痛点共鸣 + 解决方案 + 行动召唤四段式。区分信息流广告、直播间话术、带货脚本三种用途。含违禁词清单与 DOU+ 投放优化建议。
...
来源：https://skillhub.cn/skills/douyin-script-zh?namespace=user_36c7efa2
