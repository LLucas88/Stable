...
技能 ID：`hub-643b834d-china-poster-studio`

原始名称：china-poster-studio

中文用途概括：社交海报生成器，一键将文字/文章生成精美海报，支持朋友圈、小红书、抖音等平台，粘贴即生成，无需设计，适合运营、自媒体和普通用户。

适用方向：运营岗位、内容运营。四方向评分：{"internet": 0, "operations": 50, "membership": 0, "content": 62}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://skillhub.cn/skills/china-poster-studio?namespace=user_9fe56694
