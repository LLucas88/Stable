...
| [memory-management](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/c7d03b11e0a4ec837506db21fc62de70bbcfb807/protocol/memory-management/SKILL.md) | Ciclo de vida de memória HOT/WARM/COLD (capturar · promover · rebaixar · arquivar · consultar) | todas as disciplinas | estado runtime não canônico de `memory/` |
...
- **[CLAUDE.md](../CLAUDE.md)** / **[AGENTS.md](../AGENTS.upstream.md)** — contexto voltado ao agente para este repo.
