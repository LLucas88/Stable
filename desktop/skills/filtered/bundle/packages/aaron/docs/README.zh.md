...
| **Agent Plugins v1 客户端 · Portable Lite** | 从 [v20.1.0 Release](https://github.com/aaron-he-zhu/aaron-marketing-skills/releases/tag/v20.1.0)下载 `aaron-marketing-skills-20.1.0-agent-plugin-v1-lite.tar.gz`，解压后安装其中的插件目录 |
...
| [memory-management](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/c7d03b11e0a4ec837506db21fc62de70bbcfb807/protocol/memory-management/SKILL.md) | HOT/WARM/COLD 记忆生命周期（捕获 · 提升 · 降级 · 归档 · 查询） | 全部学科 | 非规范的 `memory/` 运行时状态 |
...
| 组 | 技能 |
|----|------|
| **协议层** | [entity-registry](../protocol/entity-registry/SKILL.md), [creator-registry](../protocol/creator-registry/SKILL.md), [offer-claims-registry](../protocol/offer-claims-registry/SKILL.md), [consent-registry](../protocol/consent-registry/SKILL.md), [launch-registry](../protocol/launch-registry/SKILL.md), [channel-registry](../protocol/channel-registry/SKILL.md), [narrative-registry](../protocol/narrative-registry/SKILL.md), [memory-management](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/c7d03b11e0a4ec837506db21fc62de70bbcfb807/protocol/memory-management/SKILL.md) |
...
- **[CLAUDE.md](../CLAUDE.md)** / **[AGENTS.md](../AGENTS.upstream.md)** —— 面向 Agent 的本仓库上下文。
