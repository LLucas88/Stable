...
metadata:
  source-name: positioning-mapper
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-positioning-mapper
  upstream-displayName: Positioning Mapper · 定位画布
  upstream-summary: 定位画布/竞争替代品/独特价值/滩头细分
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when defining launch positioning before any launch copy exists: naming the real competitive alternatives (including spreadsheet / manual process / status quo), isolating unique attributes, mapping value themes, choosing the beachhead segment, or writing the onlyness statement. The first move of the RAMP Research phase, the sole upstream of message-house-builder, and the entity-signal source for entity-registry. Not the message house itself and not persona research.'
  upstream-argument-hint: <product / offering> [known alternatives] [candidate segments]
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "launch", "phase": "research", "geo-relevance": "low", "hermes": {"tags": ["marketing", "launch", "research"], "category": "launch"}, "openclaw": {"emoji": "🚀", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
