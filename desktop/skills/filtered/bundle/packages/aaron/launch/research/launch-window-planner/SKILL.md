---
name: aaron-launch-window-planner
...
metadata:
  source-name: launch-window-planner
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-launch-window-planner
  upstream-displayName: Launch Window Planner · 发布窗口规划
  upstream-summary: 发布择时/竞品日历/禁运期窗口/审核缓冲
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when choosing a launch date or window: scanning industry events and conference cycles, mapping the competitor launch calendar, padding for store-review latency, choosing a launch-week vs rolling format, or defining the embargo window and lift moment. The timing layer of launch research — the chosen window becomes canonical only after launch-registry records it.'
  upstream-argument-hint: <product / launch stage> [candidate dates or quarter] [tier] [constraints]
