...
技能 ID：`aaron-message-house-builder`

原始名称：message-house-builder

中文用途概括：Use when the user asks to "build a message house", "write a PR-FAQ for our launch", or "define the launch narrative and value pillars"; derives from the positioning canvas a message house — tagline, one-liner, three value pillars, per-persona proof points (each labeled Measured / User-provided / [needs source]) — plus a working-backwards PR-FAQ narrative spine (launch-day tense, empty-chair test, five external + five internal FAQs) and per-channe
...
来源：https://github.com/aaron-he-zhu/aaron-marketing-skills/tree/c7d03b11e0a4ec837506db21fc62de70bbcfb807/launch/assemble/message-house-builder
