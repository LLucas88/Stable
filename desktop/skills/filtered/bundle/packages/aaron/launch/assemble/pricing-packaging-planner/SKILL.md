---
name: aaron-pricing-packaging-planner
...
metadata:
  source-name: pricing-packaging-planner
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-pricing-packaging-planner
  upstream-displayName: Pricing Packaging Planner · 发布定价打包
  upstream-summary: 发布定价/梯度打包/早鸟优惠/保证设计
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when deciding what a launch will charge and how it is packaged: tier structure and tier naming, mapping tiers to the message-house value pillars, launch discounts with a real deadline reason, beta or early-adopter pricing and its graduation path to the GA price, and guarantee / refund design. The pricing lever of the RAMP Assemble phase — feeds the RAMP A pricing / packaging sub-item. The live offer record stays with offer-claims-registry; subscription-newsletter economics stay with newsletter-monetization-planner.'
  upstream-argument-hint: '<product / offer> [launch goal: b2b / devtool / mobile] [current pricing if any] [launch date]'
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "launch", "phase": "assemble", "geo-relevance": "low", "hermes": {"tags": ["marketing", "launch", "assemble"], "category": "launch"}, "openclaw": {"emoji": "🚀", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
