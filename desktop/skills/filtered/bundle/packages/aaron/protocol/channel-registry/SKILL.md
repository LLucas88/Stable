...
metadata:
  source-name: channel-registry
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-channel-registry
  upstream-displayName: Channel Registry · 渠道台账
  upstream-summary: 品牌自有社媒渠道/声音档案/UGC授权/节奏承诺唯一真相
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when recording/querying channel handle/state/governance/cadence/voice pointers, UGC permissions, advocate opt-in, or accepting pending social activity/incident proposals.
  upstream-argument-hint: <channel or permission aggregate-id, transition, or proposal review>
