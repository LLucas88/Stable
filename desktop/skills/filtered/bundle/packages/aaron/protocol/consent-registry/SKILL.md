...
metadata:
  source-name: consent-registry
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-consent-registry
  upstream-displayName: Consent Registry · 订阅同意台账
  upstream-summary: 订阅同意台账/退订抑制记录/合法性依据登记
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when recording or querying opt-in/lawful-basis evidence, immediately suppressing an unsubscribe, hard bounce, or complaint, restoring after a fresh authorized opt-in, processing erasure, or reviewing pending consent proposals.
  upstream-argument-hint: <pseudonymous subject-id and consent/suppression event>
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "protocol", "phase": "protocol", "geo-relevance": "low", "hermes": {"tags": ["marketing", "protocol"], "category": "protocol"}, "openclaw": {"emoji": "🗂️", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
...
- **Erase/archive:** [memory-management](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/c7d03b11e0a4ec837506db21fc62de70bbcfb807/protocol/memory-management/SKILL.md)
