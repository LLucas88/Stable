...
metadata:
  source-name: creator-registry
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-creator-registry
  upstream-displayName: Creator Registry · 创作者档案
  upstream-summary: 创作者档案/达人名册
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when consolidating or querying creator roster facts, accepting pending creator proposals, deduplicating handles, or recording closed-cycle rates, rights, exclusivity, compliance events, and performance baselines.
  upstream-argument-hint: <creator aggregate-id/handle or 'review pending proposals'>
