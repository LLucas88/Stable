...
metadata:
  source-name: launch-registry
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-launch-registry
  upstream-displayName: Launch Registry · 发布台账
  upstream-summary: 发布台账/发布日历/阶段与禁运期唯一真相
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when recording/querying launch tier/type/stage/date/embargo, submission events, manifest version, outcome snapshot, or accepting pending launch proposals.
  upstream-argument-hint: <launch aggregate-id, transition, or pending-proposal review>
