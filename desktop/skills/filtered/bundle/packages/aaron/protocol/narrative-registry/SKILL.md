...
metadata:
  source-name: narrative-registry
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-narrative-registry
  upstream-displayName: Narrative Registry · 品牌叙事台账
  upstream-summary: 品牌叙事 canon/版本史/语气与命名唯一真相
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when recording/querying a brand's canonical positioning, narrative, message hierarchy, proof/claim pointers, voice/naming rules, conditional boilerplates, or accepting/rejecting a complete canon-version proposal.
  upstream-argument-hint: <brand aggregate-id, canon version, or pending-proposal review>
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "protocol", "phase": "protocol", "geo-relevance": "low", "hermes": {"tags": ["marketing", "protocol"], "category": "protocol"}, "openclaw": {"emoji": "📖", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
