---
name: aaron-offer-claims-registry
...
metadata:
  source-name: offer-claims-registry
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-offer-claims-registry
  upstream-displayName: Offer Claims Registry · 广告声明台账
  upstream-summary: 广告声明台账/优惠信息登记/证据溯源
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when registering, updating, expiring, or querying claims/offers; resolving pending [needs source] proposals; recording substantiation, approved wording, disclosures, terms, usage, and review dates.
  upstream-argument-hint: <claim/offer aggregate-id or 'review pending proposals'>
...
- **Archive/erase:** [memory-management](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/c7d03b11e0a4ec837506db21fc62de70bbcfb807/protocol/memory-management/SKILL.md)
