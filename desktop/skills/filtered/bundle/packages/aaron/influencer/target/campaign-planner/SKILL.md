...
metadata:
  source-name: campaign-planner
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-campaign-planner
  upstream-displayName: Campaign Planner · 活动规划
  upstream-summary: 红人活动整体规划:目标、阶段、创作者组合、时间线与风险预案
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when planning a new influencer campaign, launching a product with influencer support, building seasonal or always-on creator programs, or maintaining an existing creator-campaign tracker: recording verified publication checkpoints, deriving exception queues, reconciling payment/measurement evidence, closing creators or the campaign, and handling late evidence or manual reopen. Planning does not write briefs or execute outreach; tracking does not publish, amplify, pay, or mutate external systems.'
  upstream-argument-hint: <brand or product> [budget] [platform] [timeframe]
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "influencer", "phase": "target", "geo-relevance": "low", "hermes": {"tags": ["marketing", "influencer", "target"], "category": "influencer"}, "openclaw": {"emoji": "📣", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
