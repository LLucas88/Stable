...
metadata:
  source-name: roi-calculator
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-roi-calculator
  upstream-displayName: ROI Calculator · ROI 计算
  upstream-summary: 活动投入产出核算:成本归集、收益口径与 ROI 及 STAR 回报(R)证据汇总
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when measuring or projecting influencer campaign ROI, justifying or defending budgets, comparing ROI across campaigns or channels, evaluating individual influencer or tier value, or preparing executive-level ROI numbers. Activate when the user supplies spend and results data and wants ROI, ROAS, EMV, CPA/CAC, attribution, or LTV impact computed.
  upstream-argument-hint: <campaign name or spend> [revenue] [results data]
