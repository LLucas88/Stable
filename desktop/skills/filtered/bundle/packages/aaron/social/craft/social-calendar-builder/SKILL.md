---
name: aaron-social-calendar-builder
...
metadata:
  source-name: social-calendar-builder
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-social-calendar-builder
  upstream-displayName: Social Calendar Builder · 社媒排期日历
  upstream-summary: 常青内容日历/栏目配比/批量生产/循环复用/发布节奏
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when standing up or rebalancing the always-on social posting calendar: pillar allocation, hero/hub/help mix, give:ask ratio targets, per-channel recurring slots and queue depth, batching days, evergreen recycle rotation with freshness re-checks, deliberate realtime/trend gaps, and first-comment/publish-order ops. Not the per-post copy (social-creative-builder) and not repurposing or paid amplification (content-amplifier); no batch ships to the queue without the SHIP verdict from social-quality-auditor pre-publish mode.'
  upstream-argument-hint: <channels + committed cadence> [content pillars] [planning horizon]
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "social", "phase": "craft", "geo-relevance": "low", "hermes": {"tags": ["marketing", "social", "craft"], "category": "social"}, "openclaw": {"emoji": "📣", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
