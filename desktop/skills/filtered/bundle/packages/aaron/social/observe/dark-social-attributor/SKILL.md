---
name: aaron-dark-social-attributor
...
metadata:
  source-name: dark-social-attributor
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-dark-social-attributor
  upstream-displayName: Dark Social Attributor · 暗社交归因
  upstream-summary: 暗社交归因/直接流量分解/自报来源字段/分享链路UTM
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when direct traffic is unexplained, social ROI is questioned without click evidence, share buttons carry naked URLs, or a how-did-you-hear field is being designed: declares the dark-social estimation method (ECHO O2) and specs the instrumentation — share-link/UTM hygiene, a self-reported attribution field that replaces an existing form field, GA4 direct-traffic decomposition heuristics, and a branded-search-lift proxy via GSC + pageviews.py. Every derived number is Estimated/proxy by construction. Not for reconciling paid-platform conversion claims (attribution-reconciler) and not the metric dictionary or write-back loop (social-measurement-loop).'
  upstream-argument-hint: <GA4/GSC exports or site> [share-surface inventory] [existing form fields]
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "social", "phase": "observe", "geo-relevance": "low", "hermes": {"tags": ["marketing", "social", "observe"], "category": "social"}, "openclaw": {"emoji": "📣", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
