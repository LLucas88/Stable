...
Counted in their home phases, not duplicated here: [trend-spotter](../influencer/scout/trend-spotter/SKILL.md) (cultural timing), [audience-mapper](../influencer/scout/audience-mapper/SKILL.md) (persona), [content-amplifier](../influencer/activate/content-amplifier/SKILL.md) ("boost this" repurposing), [outreach-manager](../influencer/activate/outreach-manager/SKILL.md), [competitor-tracker](../influencer/target/competitor-tracker/SKILL.md), [community-launch-runner](../launch/mobilize/community-launch-runner/SKILL.md) (launch-day posts), plus `landing-optimizer`, `performance-analyzer`, `roi-calculator`, `report-generator`, `page-play-builder`, and the [offer-claims-registry](../protocol/offer-claims-registry/SKILL.md) / [creator-registry](../protocol/creator-registry/SKILL.md) / [memory-management](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/c7d03b11e0a4ec837506db21fc62de70bbcfb807/protocol/memory-management/SKILL.md) protocol skills.
