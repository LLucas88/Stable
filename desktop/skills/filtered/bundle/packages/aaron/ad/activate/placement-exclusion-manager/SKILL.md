---
name: aaron-placement-exclusion-manager
...
metadata:
  source-name: placement-exclusion-manager
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-placement-exclusion-manager
  upstream-displayName: Placement Exclusion Manager · 品牌安全
  upstream-summary: 品牌安全/排除位置/否定受众列表
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use before spend goes live to build brand-safety and exclusion lists: placement/site/app/channel exclusions, network opt-outs (Display/Search-partner/Audience-network), content-suitability and sensitive-topic blocks, and negative-audience/audience exclusions — then package the placements evidence the auditor needs to judge ROAS A1 (brand/placement safety).'
  upstream-argument-hint: <account/campaign goal> [platforms] [placements report path] [brand-safety constraints]
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "ad", "phase": "activate", "geo-relevance": "low", "hermes": {"tags": ["marketing", "ad", "activate"], "category": "ad"}, "openclaw": {"emoji": "🎯", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
