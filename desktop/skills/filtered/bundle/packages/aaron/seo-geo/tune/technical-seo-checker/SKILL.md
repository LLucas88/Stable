---
name: aaron-technical-seo-checker
...
metadata:
  source-name: technical-seo-checker
  bundle: ops-expanded-2026-09-06
  upstream-slug: technical-seo-checker
  upstream-displayName: Technical SEO Checker · 技术SEO
  upstream-summary: 技术SEO/网站速度
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when checking technical SEO health: site speed, Core Web Vitals, indexing, crawlability, robots.txt, sitemaps, canonical tags, 技术SEO, 网站速度, 核心网页指标, 索引问题, or Google找不到页面.'
  upstream-argument-hint: <URL or domain>
  upstream-allowed-tools: WebFetch
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "seo-geo", "phase": "tune", "geo-relevance": "low", "hermes": {"tags": ["marketing", "seo-geo", "tune"], "category": "seo-geo"}, "openclaw": {"emoji": "🔍", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
