---
name: aaron-on-page-seo-checker
...
metadata:
  source-name: on-page-seo-checker
  bundle: ops-expanded-2026-09-06
  upstream-slug: on-page-seo-checker
  upstream-displayName: On-Page SEO Checker · 页面SEO检查
  upstream-summary: 页面SEO检查/排名诊断
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when auditing a page's on-page SEO health, checking heading structure, keyword placement, image optimization, or content quality signals.
  upstream-argument-hint: <URL> [keyword]
  upstream-allowed-tools: WebFetch
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "seo-geo", "phase": "tune", "geo-relevance": "medium", "hermes": {"tags": ["marketing", "seo-geo", "tune"], "category": "seo-geo"}, "openclaw": {"emoji": "🔍", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
