...
metadata:
  source-name: content-writer
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-content-writer
  upstream-displayName: Content Writer · SEO文章写作
  upstream-summary: SEO文章写作/内容更新/排名恢复
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when writing SEO articles, blog posts, landing pages, or product descriptions targeting a keyword (mode: new), OR when updating outdated content, refreshing old articles, or recovering pages that lost traffic/rankings (mode: refresh).'
  upstream-argument-hint: '[--mode new|refresh] <topic/keyword or URL of existing content>'
