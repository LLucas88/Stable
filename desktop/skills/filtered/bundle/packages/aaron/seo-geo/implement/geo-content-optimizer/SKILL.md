---
name: aaron-geo-content-optimizer
...
metadata:
  source-name: geo-content-optimizer
  bundle: ops-expanded-2026-09-06
  upstream-slug: geo-content-optimizer
  upstream-displayName: GEO Content Optimizer · AI引用优化
  upstream-summary: AI引用优化/GEO优化/AI搜索
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when optimizing content for AI engines like ChatGPT, Perplexity, AI Overviews, Gemini, Claude, or Copilot. Also for AI citation optimization, generative engine visibility, AI引用优化, AI搜索优化, GEO优化, or 让AI引用我.
  upstream-argument-hint: <content URL or text> [target AI engine]
