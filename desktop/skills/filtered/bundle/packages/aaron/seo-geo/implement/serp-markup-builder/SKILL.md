---
name: aaron-serp-markup-builder
...
metadata:
  source-name: serp-markup-builder
  bundle: ops-expanded-2026-09-06
  upstream-slug: serp-markup-builder
  upstream-displayName: SERP Markup Builder · 标题优化
  upstream-summary: 标题优化/元描述/Schema标记/结构化数据
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when building anything in the document head for a page — title tags, meta descriptions, Open Graph and Twitter Card tags, canonical/robots meta, and JSON-LD Schema.org structured data for rich-result and answer-engine eligibility.
  upstream-argument-hint: '[meta|schema] <page URL or content>'
  upstream-allowed-tools: WebFetch
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "seo-geo", "phase": "implement", "geo-relevance": "high", "hermes": {"tags": ["marketing", "seo-geo", "implement"], "category": "seo-geo"}, "openclaw": {"emoji": "🔍", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
