...
metadata:
  source-name: keyword-research
  bundle: ops-expanded-2026-09-06
  upstream-slug: keyword-research
  upstream-displayName: Keyword Research · 关键词研究
  upstream-summary: 关键词研究/内容选题
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when starting keyword research for a new page, topic, or campaign. Also when the user asks about search volume, keyword difficulty, topic clusters, long-tail keywords, what to write about, 关键词研究, 挖词, 内容选题, or 搜什么词.
  upstream-argument-hint: <topic or seed keyword> [market/language]
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "seo-geo", "phase": "survey", "geo-relevance": "medium", "hermes": {"tags": ["marketing", "seo-geo", "survey"], "category": "seo-geo"}, "openclaw": {"emoji": "🔍", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
