---
name: aaron-competitor-analysis
...
metadata:
  source-name: competitor-analysis
  bundle: ops-expanded-2026-09-06
  upstream-slug: competitor-analysis
  upstream-displayName: Competitor Analysis · 竞品分析
  upstream-summary: 竞品分析/竞争对手
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when analyzing competitor SEO strategy, comparing domains, benchmarking against competitors, or finding competitor keywords and content gaps.
  upstream-argument-hint: <competitor URL or domain>
