...
metadata:
  source-name: rank-tracker
  bundle: ops-expanded-2026-09-06
  upstream-slug: rank-tracker
  upstream-displayName: Rank Tracker · 排名追踪
  upstream-summary: 排名追踪/SERP监控
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: Use when tracking keyword rankings, monitoring position changes, comparing ranking snapshots, or detecting ranking drops.
  upstream-argument-hint: <domain> [keyword list]
