---
name: aaron-message-system-architect
...
metadata:
  source-name: message-system-architect
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-message-system-architect
  upstream-displayName: Message System Architect · 品牌消息体系
  upstream-summary: 品牌消息屋/主叙事/三支柱/标语·一句话的持久 canon
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when authoring the durable, brand-level message hierarchy that outlives any single launch: the main narrative, three value pillars each traceable to a positioning value theme, per-persona proof points, and the tagline/one-liner. The core of the TALE Architect phase and the seed of the narrative-registry canon — the per-launch message-house-builder is reused and derives from this durable house. Not the per-launch house itself and not claim substantiation.'
  upstream-argument-hint: <product / brand> [personas] [positioning truth set path] [narrative arc path]
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "narrative", "phase": "architect", "geo-relevance": "low", "hermes": {"tags": ["marketing", "narrative", "architect"], "category": "narrative"}, "openclaw": {"emoji": "📖", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
