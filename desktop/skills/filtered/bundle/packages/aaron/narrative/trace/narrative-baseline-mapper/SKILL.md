---
name: aaron-narrative-baseline-mapper
...
metadata:
  source-name: narrative-baseline-mapper
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-narrative-baseline-mapper
  upstream-displayName: Narrative Baseline Mapper · 叙事基线盘点
  upstream-summary: 现状叙事盘点/各触点口径/意图差距/漂移基线
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use as the first move of the TALE Trace phase, before any canon exists or before a repositioning: inventory what every owned surface (homepage, pricing, docs, decks, social bios, emails) says today, capture the gap vs the intended message, and freeze the drift baseline the Evaluate phase measures against. The before snapshot — not the canon itself and not the score.'
  upstream-argument-hint: <brand / product> [surface URLs or paste] [intended message, if known]
  upstream-metadata: '{"author": "aaron-he-zhu", "version": "20.1.0", "discipline": "narrative", "phase": "trace", "geo-relevance": "low", "hermes": {"tags": ["marketing", "narrative", "trace"], "category": "narrative"}, "openclaw": {"emoji": "📖", "homepage": "https://github.com/aaron-he-zhu/aaron-marketing-skills"}}'
license: Apache-2.0
