---
name: aaron-audience-belief-mapper
...
metadata:
  source-name: audience-belief-mapper
  bundle: ops-expanded-2026-09-06
  upstream-slug: aaron-audience-belief-mapper
  upstream-displayName: Audience Belief Mapper · 受众信念图
  upstream-summary: 受众信念/异议/切换四力/流失语言
  upstream-version: 20.1.0
  upstream-homepage: https://github.com/aaron-he-zhu/aaron-marketing-skills
  upstream-when_to_use: 'Use when gathering the beachhead''s narrative raw material before any brand narrative is authored: the beliefs and mental models buyers already hold, the objections they raise and how to reframe each, and the JTBD four forces (push / pull / anxiety / habit) that govern switching. The third move of the TALE Trace phase; feeds beachhead truth (T), objection reframes (A), and win-loss language (E). Not demographic persona profiling and not the positioning canvas.'
  upstream-argument-hint: <product / beachhead> [interview / win-loss notes] [known objections]
