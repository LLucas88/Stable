...
技能 ID：`hub-d6150a32-ai-poster-deck`

原始名称：ai-poster-deck

中文用途概括：生成 1-12 张海报式幻灯片，专为朋友圈、小红书封面、视频号封面、九宫格设计。输出完整设计 brief + AI 图像生成提示词，给即梦/通义万相/GPT Image 用。
...
来源：https://skillhub.cn/skills/ai-poster-deck?namespace=user_36c7efa2
