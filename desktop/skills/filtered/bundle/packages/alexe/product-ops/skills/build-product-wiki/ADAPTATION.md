...
技能 ID：`alexe-build-product-wiki`

原始名称：build-product-wiki

中文用途概括：支持产品规划、用户研究或业务策略。

适用方向：互联网业务、会员运营。四方向评分：{"internet": 86, "operations": 0, "membership": 50, "content": 0}。评分是可复现规则辅助判断，未在你的业务环境测得精确相关度；证据见根目录 manifest.json。
...
来源：https://github.com/alexe-ev/product-plugins/tree/f4e26ef0827133c52a8aecf238b7ee8780606f57/product-ops/skills/build-product-wiki
