...
test('skill categories, neutral platform labels, distinct icons and dependency restrictions render in the real market', {skip:process.platform!=='win32',timeout:30000},async()=>{
